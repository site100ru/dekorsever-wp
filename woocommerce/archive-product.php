	...
	<div class="container">
		...
		<div class="row">
			<div class="col text-center">
				<h2 class="mb-2">Каталог проектов</h2>
						...
						<div class="row">
							...
							if ( woocommerce_product_loop() ) {
								...
								if ( wc_get_loop_prop( 'total' ) ) {
									...
									/* Эта функция работает из functions.php */
	...
	<div class="container">
		<div class="row">
			<div class="col text-md-center">
					...
					<?php	
						...
						switch ( $portfolio_cat ) {
							case 'Кухни':
								...
								$portfolio_link = 'https://dekorsever.ru/portfolio-cat/01-кухни/';
								break;
							case 'Шкафы':
								$portfolio_cat = '02-шкафы';
								$portfolio_link = 'https://dekorsever.ru/portfolio-cat/02-шкафы/';
								break;
							case 'Корпусная мебель':
								$portfolio_cat = ['03-столы', '04-тумбы', '05-разное', ];
								$portfolio_link = 'https://dekorsever.ru/portfolio/';
								break;
							case 'product':
								$portfolio_cat = ['01-кухни', '02-шкафы', '03-столы', '04-тумбы', '05-разное', ];
								$portfolio_link = 'https://dekorsever.ru/portfolio/';
								break;
						}
				...
				<a href="<?php echo $portfolio_link; ?>" class="btn btn-lg btn-corporate-color-1" style="margin-top: 12px;">Смотреть еще</a>
			</div>
		</div>
	</div>
</section>
					...
					<div class="col-md-6 mb-5">
						<div class="row">
							...
							<div class="col-10">
								...
								<p class="mb-0">Приобретайте напрямую у производителя с опытом работы более 9 лет, без переплаты посредникам.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mb-5">
						<div class="row">
							...
							<div class="col-10">
								...
								<p class="mb-0">Замерщик приезжает, производит замер и делает расчет стоимости. Заказчик оплачивает выезд замерщика в размере 2000 руб, 
									и если заключается договор, то тогда замер бесплатный и оплаченный выезд засчитывается в сумму предоплаты.</p>
							</div>
						</div>
					</div>
					<div class="col-md-6 mb-5">
					...
					<div class="col-md-6 mb-5">
						<div class="row">
							...
							<div class="col-10">
								...
								<p class="mb-0">Установка "под ключ". Самовывоз г.о. Мытищи. Доставка по Москве и МО.</p>
							</div>
						</div>
					</div>
					<!--div class="col-md-6 mb-5">
					...
					<div class="col-md-6 mb-5">
						<div class="row">
							...
							<div class="col-10">
								...
								<ul class="mb-0 text-corporate-color-1 ps-0" style="">
									...
									<li style="line-height: 24px;"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/menu-point.svg" class="me-2">Наличными </li>
									<li style="line-height: 24px;"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/menu-point.svg" class="me-2">Онлайн</li>
