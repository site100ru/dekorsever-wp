	...
	<div class="container">
		<div class="row align-items-center text-start" style="min-height: 410px;">
			<div class="col py-5">
				...
				<?php
					if ( is_shop() ) {
						echo '<h2 class="mb-4 mb-md-5 header-sub-title">Корпусная мебель на заказ по Вашим размерам</h2>';
					} else {
						echo '<h2 class="mb-4 mb-md-5 header-sub-title">На заказ по Вашим размерам</h2>';
					}
				?>
				<?php
				/**
						...
						<div class="row">
							...
							<div class="col-10">
								...
								<ul class="mb-0 text-corporate-color-1 ps-0" style="">
									...
									<li style="line-height: 24px;"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-point.svg" class="me-2">Наличными </li>
									<li style="line-height: 24px;"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-point.svg" class="me-2">Онлайн</li>
