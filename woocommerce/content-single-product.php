			...
			<div class="row">
				<div class="col">
					<nav class="breadcrumbs mb-4">
						<a href="https://dekorsever.ru/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/breadcrumbs-icon.svg"></a> / 
						<a href="https://dekorsever.ru/catalog/" style="text-decoration: none;">Каталог</a> / 
