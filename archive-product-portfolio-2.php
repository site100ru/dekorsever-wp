...
<section class="archive-portfolio-section-2 pt-4 bg-white" style="padding-bottom: 60px;">
	<div class="container">
		...
		<div class="row text-md-center">
			<div class="col">
				<a href="/portfolio-cat/01-кухни/" type="button" class="btn btn-lg btn-corporate-color-1">Показать еще</a>
			</div>
		</div>
	</div>
</section>				
				...
				<div class="row justify-content-md-end">
					<div class="col">
						<ul class="nav justify-content-md-end">
							...
							<li class="nav-item">
								<a class="nav-link ico-button px-2" href="https://t.me/+79361385058">
									<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/ico/telegram-ico.svg">
								</a>
							</li>
                            <li class="nav-item">
								<a class="nav-link ico-button px-2" href="https://max.ru/u/f9LHodD0cOIaPC-JT3CO_gR8lX_0r8w8ZdryldFEBqfWiLtrMWwQNmVViZk">
	...
	<div class="container">	
		<div class="row justify-content-between">		
			...
			<div class="col-12 col-lg-5 offset-lg-1 order-1 order-lg-last mb-5 mb-lg-0 ps-lg-5">
				...
				<p class="text-start">Желаете пополнить свой дом эксклюзивной кухней? Смело обращайтесь в компанию «Декор-Север». Любая заказанная у нас кухня отличается долговечностью и внешней элегантностью. Все наши кухни будут долго радовать Вас своим изысканным видом, создавая атмосферу уюта и защищённости.</p>
				<a href="/about-us" type="button" class="btn btn-lg btn-corporate-color-1">Узнать больше</a>
			</div>
		</div>
	</div>	
</section>		
